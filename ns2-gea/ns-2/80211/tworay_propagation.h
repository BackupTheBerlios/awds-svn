...
#ifndef TWORAY_PROPAGATION_H
#define TWORAY_PROPAGATION_H
...
class TwoRayPropagation : public FreeSpacePropagation {
public:
	TwoRayPropagation ();

	virtual double getReceptionPower (Packet *packet);
